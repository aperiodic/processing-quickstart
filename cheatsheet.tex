...
A more natural way of representing colors is with hue, saturation, and brightness.

The hue is the base coloring of the color, before it's modified by the saturation and brightness values.
The hue starts and ends at red, and in between covers the whole color wheel.

The saturation is how strong the color is.
Full saturation means the color is as intensely colored as possible.
A saturation of zero produces values of grey.

The brightness is how much light the color emits.
